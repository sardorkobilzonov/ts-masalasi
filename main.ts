...
//6-MASALA
{
  function kattasiniAniqlash(son1: number, son2: number): number {
    if (son1 > son2) {
      return son1;
    } else {
      return son2;
...
//7-MASALA
{
  function kichiginiAniqlash(son1: number, son2: number): string {
    if (son1 < son2) {
...
//8-MASALA
{
  function kattasiVaKichiginiAniqlash(son1: number, son2: number): void {
    if (son1 > son2) {
...
//9-MASALA
{
  function ozgartirishAgarKerak(a: number, b: number): void {
    if (a > b) {
      let temp = a;
      a = b;
      b = temp;
...
//6-MASALA
{
  function parallelepipedHajmi(a: number, b: number, c: number): number {
    return a * b * c;
  }

  function parallelepipedTolaSirti(a: number, b: number, c: number): number {
