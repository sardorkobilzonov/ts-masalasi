...
//6-MASALA
{
    function parallelepipedHajmiVaSirti(a, b, c) {
        const hajmi = a * b * c;
...
//7-MASALA
{
    function doiraUzunligiVaYuzasi(R) {
        const pi = 3.14;
...
//8-MASALA
{
    function ikkitaSonOrtaArifmetigi(a, b) {
        return (a + b) / 2;
    }
    const a = 8;
    const b = 12;
...
//9-MASALA
{
    function ikkitaSonOrtaGeometrigi(a, b) {
        if (a < 0 || b < 0) {
...
//10-MASALA
{
    function nolgaTengBolmaganSonlarNatijalari(a, b) {
        if (a === 0 || b === 0) {
...
//12-MASALA
{
    function togriUchburchakGipotenuzaVaPerimetr(a, b) {
        if (a <= 0 || b <= 0) {
